...
<div class="content px-3 py-2">
    <div class="card">
       ...
       <div class="col-lg-5">
            ...
            <?php
                            if (empty($result)) {
                                echo "<b>Data Pesanan tidak ada</b>";
                            } else {
...
<div class="modal fade" id="bayar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <span class="fw-semibold fs-5">Apakah Anda Ingin Melakukan Pembayaran??</span>
              <form class="text-center needs-validation" novalidate action="proses/bayar.php"
                ...
                <input type="hidden" name="sub" value="<?php foreach($result as $row){ echo $row['hasilnya'];} ?>">
                <input type="hidden" name="id_detail" value="<?php foreach($result as $row){ echo $row['id_detail'];} ?>">
                <input type="hidden" name="id_produk" value="<?php foreach($result as $row){ echo $row['id_produk'];} ?>">
                <div class="row">
                  <div class="col-lg-6">
      ...
      ?>
            ...
            <?php } ?>
            <div class="column d-flex justify-content-start mt-2" >
        <a class="btn btn-dark border-light me-2 fw-semibold" disabled href="./penjualan"><i class="bi bi-arrow-left-circle"></i> Back</a>
