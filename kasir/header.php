...
<nav class="navbar navbar-expand border-bottom border-body bg-dark sticky-top" data-bs-theme="dark">
        <div class="container-lg">
            ...
            <div class="offcanvas-body">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo (isset($_GET['x']) && $_GET['x']=='produk' || !isset($_GET['x'])) ? "active link-light bg-dark" : "" ; ?> ps-2" href="produk"> Produk</a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link <?php echo (isset($_GET['x']) && $_GET['x']=='pelanggan') ? "active link-light bg-dark" : "" ; ?> ps-2" href="pelanggan"> Pelanggan</a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link <?php echo (isset($_GET['x']) && $_GET['x']=='penjualan') ? "active link-light bg-dark" : "" ; ?> ps-2" href="penjualan"> Penjualan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo (isset($_GET['x']) && $_GET['x']=='datapjl') ? "active link-light bg-dark" : "" ; ?> ps-2" href="datapjl"> Data Penjualan</a>
                                    </li>
                                </ul>
                            </div>
